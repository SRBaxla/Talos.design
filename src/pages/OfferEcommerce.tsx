...
export default function OfferEcommerce() {
        ...
        <div className="container py-16 flex flex-col flex-grow">
            ...
            <div className="mb-16">
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex items-center gap-2 mb-6">
                    <span className="text-[10px] font-mono bg-[rgba(245,158,11,0.1)] text-[var(--accent-orange)] px-3 py-1 rounded-full border border-[rgba(245,158,11,0.2)]">E-Commerce</span>
                </motion.div>
                ...
                <motion.p {...fadeUp} transition={{ delay: 0.2 }} className="text-lg text-[var(--text-secondary)] max-w-2xl leading-relaxed">
                    Engineer a fast, robust digital storefront. Select the modules that fit your brand's growth phase. The base setup
                    is selected by default to ensure maximum conversions.
                </motion.p>
            </div>
