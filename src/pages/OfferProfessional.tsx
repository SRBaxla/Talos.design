...
export default function OfferProfessional() {
    ...
    const handleCreateProject = () => {
        ...
        navigate('/contact', {
            state: {
                bundleType: 'Consultation & SaaS platforms',
        ...
        <div className="container py-16 flex flex-col flex-grow">
            ...
            <div className="mb-16">
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="flex items-center gap-2 mb-6">
                    <span className="text-[10px] font-mono bg-[rgba(192,132,252,0.1)] text-[#c084fc] px-3 py-1 rounded-full border border-[rgba(192,132,252,0.2)]">Professional Services</span>
                </motion.div>
                <motion.h1 {...fadeUp} transition={{ delay: 0.1 }} className="text-4xl md:text-6xl font-display tracking-tight mb-6">
                    Consultation & <span className="text-[#c084fc]">SaaS Platforms.</span>
                </motion.h1>
                <motion.p {...fadeUp} transition={{ delay: 0.2 }} className="text-lg text-[var(--text-secondary)] max-w-2xl leading-relaxed">
                    Elevate your service delivery with scalable infrastructure. Select the modules that match your workflows. The base setup
                    is selected by default to establish essential operations.
                </motion.p>
            </div>
