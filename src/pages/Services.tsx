    ...
    return (
        <div className="container py-16 flex flex-col items-center flex-grow">
            ...
            <div className="flex flex-col items-center text-center max-w-3xl mb-32">
                ...
                <h1 className="text-5xl md:text-7xl font-display uppercase tracking-tighter mb-6 leading-none">
                    Automate Your <br />
                    <span className="text-[var(--accent-orange)]">Aesthetic</span>
                </h1>

                <div className="badge badge-active mb-6 font-mono text-xs">
                    [SYSTEM_STATUS: ACTIVE]
                </div>

                <p className="text-[var(--text-secondary)] mb-10 text-lg leading-relaxed max-w-2xl px-4">
            ...
            <div className="w-full max-w-6xl mb-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {/* Card 1 */}
                    <div className="glass-panel p-8 bg-[rgba(18,18,20,0.8)] border-t border-t-[rgba(255,255,255,0.1)]">
            ...
            <div className="w-full max-w-6xl mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Project 1 */}
                    <div className="glass-panel overflow-hidden group border-t border-t-[rgba(255,255,255,0.1)]">
