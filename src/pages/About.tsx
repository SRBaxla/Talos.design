...
export default function About() {
    ...
    return (
        <div className="flex flex-col flex-grow relative" ref={containerRef}>
            ...
            <div className="sticky top-0 left-0 w-full h-screen overflow-hidden flex flex-col items-center justify-center pt-10 z-0">
                ...
                <motion.div
                    ...
                    className="container flex flex-col items-center text-center relative z-10 pb-20"
                >
                    <motion.div
                        initial={{ opacity: 0, scale: 0.8 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ delay: 0.1 }}
                        className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-[rgba(18,18,20,0.8)] border border-[rgba(245,158,11,0.3)] shadow-[0_0_30px_rgba(245,158,11,0.15)] flex items-center justify-center mb-8"
                    >
                        <Shield className="text-[var(--accent-orange)] w-10 h-10 md:w-12 md:h-12" />
                    </motion.div>
                    ...
                    <motion.h1
                        ...
                        className="text-4xl sm:text-5xl md:text-7xl font-display tracking-tight leading-tight mb-6"
                    >
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center gap-2 mb-2 text-xs md:text-sm text-[var(--text-secondary)] font-mono px-4"
                    >
                    ...
                    <motion.div
                        ...
                        className="flex flex-col items-center text-[10px] text-[var(--accent-orange)] font-mono uppercase tracking-widest gap-2 opacity-80 mt-2"
                    >
                        SCROLL TO INITIATE
            ...
            <div className="relative z-20 bg-[var(--bg-base)] w-full flex flex-col items-center pb-24 border-t border-[var(--border-color)] shadow-[0_-20px_50px_rgba(0,0,0,0.8)] pt-32">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-16 mb-40 items-center px-4"
                >
                    <div>
                ...
                <div className="w-full max-w-3xl mb-40 flex flex-col items-center px-4">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.1 }}
                        className="text-[10px] font-mono text-[var(--text-muted)] uppercase tracking-widest mb-16 overflow-hidden max-w-full relative inline-block"
                    >
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="w-full max-w-4xl flex flex-col items-center text-center mt-16 mb-24 relative z-20 px-4"
                >
