            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 mb-16">
                    ...
                    <div className="flex flex-col gap-4">
                        <Link to="/" className="flex items-center gap-3 group">
                            ...
                            <span className="font-display font-bold text-xl tracking-tight text-[var(--text-primary)]">Talos.design</span>
                        </Link>
                        ...
                        <div className="mt-4 pt-4 border-t border-[var(--border-color)] flex flex-col gap-2.5 text-xs text-[var(--text-muted)]">
                            ...
                            <a href="tel:+918090489112" className="flex items-center gap-2.5 hover:text-[var(--accent-orange)] transition-colors">
                                <Phone size={14} className="text-[var(--accent-orange)] shrink-0" />
                                <span>+91 80904 89112</span>
                            </a>
                            <a href="mailto:hello@talos.design" className="flex items-center gap-2.5 hover:text-[var(--accent-orange)] transition-colors">
                    ...
                    <div>
                        <h4 className="font-display font-bold uppercase tracking-widest text-xs text-[var(--text-primary)] mb-6">Services &amp; Packages</h4>
                    ...
                    {/* Col 3: Solutions */}
                    <div>
                        <h4 className="font-display font-bold uppercase tracking-widest text-xs text-[var(--text-primary)] mb-6">Solutions</h4>
                        <ul className="flex flex-col gap-3 text-xs text-[var(--text-secondary)]">
                            ...
                            <li><Link to="/solutions" className="hover:text-[var(--accent-orange)] transition-colors text-[var(--text-primary)]/90">All Industry Solutions</Link></li>
                        </ul>
                    </div>

                    {/* Col 4: Experience & Company */}
                    <div>
                        <h4 className="font-display font-bold uppercase tracking-widest text-xs text-[var(--text-primary)] mb-6">Company &amp; Studio</h4>
                        <ul className="flex flex-col gap-3 text-xs text-[var(--text-secondary)]">
                    ...
                    <div>
                        <h4 className="font-display font-bold uppercase tracking-widest text-xs text-[var(--text-primary)] mb-6">Connect With Us</h4>
                        <p className="text-xs text-[var(--text-secondary)] mb-4 leading-relaxed">
                            Have questions or ready to launch your build? Talk directly with our team.
                        </p>

                        <div className="flex flex-col gap-3 mb-6">
                            <Link to="/contact" className="w-full py-2.5 rounded-xl bg-[var(--accent-orange)] text-[var(--btn-text-primary)] font-bold text-xs uppercase tracking-wider text-center hover:brightness-110 transition-all shadow-[0_0_15px_rgba(212,175,55,0.3)]">
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noreferrer" 
                                className="w-full py-2.5 rounded-xl border border-[var(--border-color)] text-[var(--text-secondary)] font-bold text-xs uppercase tracking-wider text-center flex items-center justify-center gap-2 hover:bg-[var(--bg-surface-elevated)] transition-all"
                            >
                        ...
                        <div className="flex items-center gap-3 text-[var(--text-muted)]">
                            <a href="https://x.com/talosDesign" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-[var(--bg-surface-elevated)] border border-[var(--border-color)] flex items-center justify-center hover:text-[var(--accent-orange)] hover:border-[var(--accent-orange)] transition-colors" aria-label="Twitter">
                                <Twitter size={16} />
                            </a>
                            <a href="https://www.instagram.com/talos.design/" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-[var(--bg-surface-elevated)] border border-[var(--border-color)] flex items-center justify-center hover:text-[var(--accent-orange)] hover:border-[var(--accent-orange)] transition-colors" aria-label="Instagram">
                                <Instagram size={16} />
                            </a>
                            <a href="https://www.linkedin.com/company/talos-design-solutions" target="_blank" rel="noreferrer" className="w-9 h-9 rounded-lg bg-[var(--bg-surface-elevated)] border border-[var(--border-color)] flex items-center justify-center hover:text-[var(--accent-orange)] hover:border-[var(--accent-orange)] transition-colors" aria-label="LinkedIn">
                                <Linkedin size={16} />
                            </a>
                        </div>
                    </div>
                ...
                <div className="border-t border-[var(--border-color)] pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-[var(--text-muted)] gap-4">
                    ...
                    <div className="flex gap-6">
                        <Link to="/legal#privacy" className="hover:text-[var(--text-primary)] transition-colors">Privacy Policy</Link>
                        <Link to="/legal#terms" className="hover:text-[var(--text-primary)] transition-colors">Terms of Service</Link>
                        <Link to="/legal#security" className="hover:text-[var(--text-primary)] transition-colors">Security &amp; Governance</Link>
                    </div>
                </div>
            </div>
        </footer>
