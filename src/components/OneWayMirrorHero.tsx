...
import './OneWayMirrorHero.css';

export const OneWayMirrorHero: React.FC = () => {
  return (
    <section 
      id="hero" 
      className="hero-wrapper"
    >
      {/* Frosted Bubbling Glassmorphic Background Layer with Dynamic Light Ray & Gold Dust */}
      <div className="frosted-glass-hero-bg">
        <div className="hero-light-ray" />
        
        {/* Dynamic Gold Dust Particles Drifting along Light Ray */}
      ...
      <div className="content-layer">
        <h1 className="hero-headline">
          <span className="mask-wrapper">
            <span className="mask-text line-1">Automate Operations.</span>
          </span>
          <span className="mask-wrapper">
            <span className="mask-text line-2">Scale Revenue.</span>
          </span>
        </h1>
...
export default OneWayMirrorHero;
